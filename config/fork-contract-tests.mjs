...
export const FORK_ADDED_TESTS = [
  ...
  'src/shared/agent-model-badge-settings.test.ts',
  'src/renderer/src/components/terminal-pane/agent-model-badge-reading.test.ts',
  'src/renderer/src/components/terminal-pane/AgentModelBadge.test.tsx',
