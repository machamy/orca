...
import { KEYBINDING_DEFINITION_UNITY } from './definitions-unity'
...
export const KEYBINDING_DEFINITIONS: readonly KeybindingDefinition[] = [
  ...
  // Why here and not appended: the Unity chords were the last `Global` entries in core-3, so this
  // slot keeps the Settings shortcut list in exactly the order it had before the split.
  ...KEYBINDING_DEFINITION_UNITY,
