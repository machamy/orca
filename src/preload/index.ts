...
// Fork: per-worktree Unity actions (seed Library cache, open editor/Rider, tint).
const unityApi: UnityApi = {
  worktreeStatus: (args) => ipcRenderer.invoke('unity:worktreeStatus', args),
  seedWorktreeCache: (args) => ipcRenderer.invoke('unity:seedWorktreeCache', args),
  openProject: (args) => ipcRenderer.invoke('unity:openProject', args),
  applyWorktreeTint: (args) => ipcRenderer.invoke('unity:applyWorktreeTint', args),
  openInRider: (args) => ipcRenderer.invoke('unity:openInRider', args)
}
