...
export function shouldRemoveProjectFromContextMenu(
  ...
  // Fork: the repo-path checkout is the project folder even when a
  // default-worktree switch left it as a linked worktree — git's
  // isMainWorktree flag follows the displaced side, so path decides.
